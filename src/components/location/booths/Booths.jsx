...
import { getBoothHierarchyUrl } from "@/utils/locationHierarchyUrl";
...
const ProductInfoOne = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setFilter("search", search, "booths");
    }, 500);
          ...
          <div className="d-flex align-items-center gap-3">
            <div>
              <select
                ...
                value={filters.limit}
                onChange={(e) => setFilter("limit", Number(e.target.value), "booths")}
                    ...
                    <div className="mt-auto pt-16 border-top">
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          <Link
                            href={getBoothHierarchyUrl(booth)}
          ...
          <ul className="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center mb-0">
            <li className="page-item">
              <button
                ...
                onClick={() => setFilter("page", pagination.page - 1, "booths")}
            ...
            {pageNumbers.map((page) => (
              <li key={page} className="page-item">
                <button
                  type="button"
                  onClick={() => setFilter("page", page, "booths")}
