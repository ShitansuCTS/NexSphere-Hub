...
import StateForm from "@/components/location/booths/forms/CreateBooth";
...
const ProductInfoOne = () => {
  ...
  const { booths, loading, fetchLocations, pagination, filters, setFilter } =
    useLocationStore();
  const start =
                    ...
                    <div className="mt-auto pt-16 border-top">
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <Link
                            href={`/location/booths/edit/${booth.id}`}
