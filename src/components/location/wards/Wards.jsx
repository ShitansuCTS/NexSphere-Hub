...
import StateForm from "@/components/location/wards/forms/CreateWard";
...
const ProductInfoOne = () => {
  ...
  const { wards, loading, fetchLocations, pagination, filters, setFilter } =
    useLocationStore();
  const start =
                    ...
                    <div className="mt-auto pt-16 border-top">
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <Link
                            href={`/location/wards/edit/${ward.id}`}
