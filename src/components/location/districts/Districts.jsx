...
const ProductInfoOne = () => {
  const { districts, loading, fetchLocations } = useLocationStore();
        ...
        <div className="row g-3">
            ...
            <div className="col-xl-3 col-sm-6" key={state.id}>
              <div className="px-24 py-16 rounded-3 border border-neutral-200 sales-card-gradient-bg-1">
                <div className="d-flex justify-content-between align-items-center gap-12">
                  ...
                  <span>
                    <Link
                      href={`/location/districts/${state.id}`}
                    ...
                    <Link
                      href={`/location/districts/edit/${state.id}`}
          ...
          {districts.length === 0 && (
            <div className="col-12">
              <p className="mb-0 text-secondary-light">No districts found</p>
            </div>
          )}
        </div>
      </div>
