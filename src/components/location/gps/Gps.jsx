...
import StateForm from "@/components/location/gps/forms/CreateGp";
...
const ProductInfoOne = () => {
  ...
  const { gps, loading, fetchLocations, pagination, filters, setFilter } =
    useLocationStore();
  const start =
            ...
            {gps.length === 0 && (
              <div className="col-12">
                <div className="card border text-center py-5">
                  ...
                  />
                  <h6 className="mb-1">No gps Found</h6>
