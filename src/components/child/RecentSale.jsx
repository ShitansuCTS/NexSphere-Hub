            ...
            <div className="card h-100 rounded-4 overflow-hidden border-0">
                <div className="card-header">
                    <div className="d-flex align-items-center flex-wrap gap-2 justify-content-between">
                        <h6 className="mb-2 fw-bold text-lg mb-0">Recent Sale Property</h6>
                        <a
                            href="#"
                ...
                <div className="card-body p-0">
                    ...
                    <div className="d-flex align-items-center justify-content-between gap-3 py-12 px-16 border-bottom border-neutral-200">
                        ...
                        <div className="d-flex align-items-end flex-column gap-8">
                            <span className="text-secondary-light text-md fw-medium line-height-1">
                                $5,000
                            </span>
                            <span className="text-success-600 text-md fw-medium line-height-1">
                                + 12.50%
                            </span>
                        </div>
                    </div>
                    <div className="d-flex align-items-center justify-content-between gap-3 py-12 px-16 border-bottom border-neutral-200">
                        ...
                        <div className="d-flex align-items-end flex-column gap-8">
                            ...
                            <span className="text-danger-600 text-md fw-medium line-height-1">
                                - 5.50%
                            </span>
                        </div>
                    </div>
