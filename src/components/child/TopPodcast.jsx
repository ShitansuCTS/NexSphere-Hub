          ...
          <div className="d-flex align-items-center justify-content-between gap-3">
            ...
            <div className="d-flex align-items-center gap-8">
              <div className="d-flex align-items-center gap-1">
                <span className="text-md text-warning-600 d-flex line-height-1">
              ...
              <span className="text-primary-light text-sm d-block text-end fw-semibold">
                5.00
              </span>
            </div>
          </div>
          <div className="d-flex align-items-center justify-content-between gap-3">
            ...
            <div className="d-flex align-items-center gap-8">
              <div className="d-flex align-items-center gap-1">
                ...
                <span className="text-md text-neutral-300 d-flex line-height-1">
                  <i className="ri-star-fill" />
                </span>
                <span className="text-md text-neutral-300 d-flex line-height-1">
                  <i className="ri-star-fill" />
